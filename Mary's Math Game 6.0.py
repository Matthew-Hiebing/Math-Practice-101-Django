...
print("Hello brave student, welcome to Math 101. In this game you will be presented a random math problem that you will need to solve.  It will be a random choice of addition, subtraction, multiplication, and division. You will have 2 guesses for each problem, after that, GAMEOVER!. \nHere's your first problem: ")
...
while guessesTaken <= 2: #The while loop will continue to work until guessesTaken is <=2.
	if op == "+": #If the operator is "+" it runs through the loop below.
		...
		answer = int(input())
		if answer == result: # If the user answers correctly it allows you to keep play.
